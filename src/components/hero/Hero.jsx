  ...
  return (
    ...
    >
      <div className="container pt-[153px] flex justify-end">
        <div className="w-[643px] h-[443px] bg-[#ffffffb9] rounded-[10px] px-[41px] pb-[37px] pt-[62px]">
          ...
          <p className='font-medium text-[18px] leading-[133%] text-[#333] max-w-[500px] mb-[46px]'>
